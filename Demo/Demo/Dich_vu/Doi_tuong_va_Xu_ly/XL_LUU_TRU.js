...
function Doc_Thong_tin_Cua_hang() {
  ...
  var Thong_tin_Cua_hang = JSON.parse(Chuoi_JSON)
  return Thong_tin_Cua_hang
}
...
class XL_LUU_TRU {
  ...
  Doc_Du_lieu_Bien_so() {
    var Du_lieu = {}
    Du_lieu.Thong_tin_Hoc_sinh = Doc_Thong_tin_Hoc_sinh()
    Du_lieu.Diem_HK1 = Doc_Diem_Hoc_Ky_I();
    Du_lieu.Diem_HK2 = Doc_Diem_Hoc_Ky_II();
    return Du_lieu
  }

  Doc_Du_lieu_Dien_thoai() {
    var Du_lieu = {}
